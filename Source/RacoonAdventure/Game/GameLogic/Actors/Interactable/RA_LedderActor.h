...
#include "RA_LedderActor.generated.h"

/**
 * 
 */
UCLASS()
class RACOONADVENTURE_API ARA_LedderActor : public ARA_InteractableActor
{
	GENERATED_BODY()
	
		ARA_LedderActor(const FObjectInitializer& ObjectInitializer);
